...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.toolButton_3.clicked.connect(self.call_api_encrypt)
        self.ui.toolButton_2.clicked.connect(self.call_api_decrypt)
        self.ui.toolButton_4.clicked.connect(self.call_api_sign)
        self.ui.toolButton_5.clicked.connect(self.call_api_verify)
